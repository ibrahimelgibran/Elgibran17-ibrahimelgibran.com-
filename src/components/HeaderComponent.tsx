  ...
  return (
    <React.Fragment>
      <Box
        ...
        backgroundColor={{
          base: isScrolled ? "background" : "transparent",
          lg: isScrolled ? "rgba(255, 255, 255, 0.1)" : "transparent",
        }}
      ...
      >
        ...
        <Container
          ...
          height={{
            base: isScrolled ? "calc(3.5rem + 1rem)" : "calc(4.5rem + 1rem)",
